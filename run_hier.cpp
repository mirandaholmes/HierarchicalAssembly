...
int main(int argc, char** argv)
{
    ...
    // Process input
    if(argc <= 2) {    
        cout << "Not enough input arguments! \nUsage: <program name> <inputfile> <e1> " << endl;
        return 1;
    }
    ...
    cout << "inputfile = " << inputfile << ", e1 = " << e1 << endl;
    ...
    //statfile = filehead + "_e" + to_string((int)(e1*100+0.5)) + "_stats.txt";
    //trajfile = filehead + "_e" + to_string((int)(e1*100+0.5)) + "_traj.txt";
