...
public:
    ...
    /*! \param particles
        ...
        \\ MHC
        \param  islattice  (optional)
             Wehther particles are confined to a lattice (unit cell = +=1)
        // end MHC
     */
    void random(std::vector<Particle>&, CellList&, Box&, MersenneTwister&, bool, bool islattice = false);
