    ...
    */
    ...
    public:
        ...
        /*! \param nParticles_
            ...
            \\ MHC
            \param isLattice_
                Whether the particles must stay on a unit lattice
        ...
        */
        ...
        double hydrAlpha = 1.0;      // MHC: scaling factor to alter hydrodynamic mobility. 1 = Stokes, 0 = unit diffusion for all clusters. 
        double ScaleMax = 1.0;       // MHC: maximum scaling factor to consider. 
